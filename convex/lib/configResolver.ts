...
const HARDCODED_DEFAULTS: Record<string, any> = {
  ...
  auto_recall_limit: 3,
  auto_recall_rrf_k: 60,
  auto_recall_strategy: "hybrid",
  system_prompt_sections: null,
  recall_ranking_weights: null,
  budget_compact_threshold_ratio: 0.7,
  budget_offload_threshold_ratio: 2,
  intent_detection_threshold: 0.6,
  importance_weights: {
    decision: 0.8,
    error: 0.7,
    insight: 0.75,
