...
Beads are **epics/tasks/subtasks with dependency structure**, optimized for AI...
...
- Trade-offs need to be explored with th...
...
2. **Plan reading & bead creation (Wave 0)**: I read the plan (262 lines), reviewed existing ba...
